  ...
  return (
    <div>
      <div>
        ...
        />
        <div className="min-w-screen  bg-blue-100 flex items-center p-5 h-screen lg:p-20  overflow-hidden relative">
            ...
            <div className="w-full md:w-1/2">
              ...
              <div style={{ 
                ...
                >
                  ...
                  <img
                    src="https://w.ladicdn.com/s450x400/5aa6273ea81f66ca2eacc40b/logo315xanh-vuong-20210316024509.png"
                    alt="#"
                    style={{width:83}}
                  />
                  Nhi Đồng 315
                </Link>
                <Link to="https://www.phusan315.com/"
                style={{
                    backgroundColor: "#df60a3",
                    color: "white",
                    textDecoration: "none",
                    padding: "0px 10px",
                    borderRadius: 6,
                    ...
                    <img
                    src="https://w.ladicdn.com/s450x400/5aa6273ea81f66ca2eacc40b/phu-san-315-20220326030218.png"
                    alt="#"
                    style={{width:100}}
                  />
                    Phụ sản 315</Link>
                    <Link to="https://www.tiemchungnhi.com/"
                style={{
                    backgroundColor: "#71c055",
                    color: "white",
                    textDecoration: "none",
                    padding: "0px 10px",
                    borderRadius: 6,
                    ...
                    <img
                    src="https://img.gotit.vn/compress/brand/1663044995_yYe2O.png"
                    alt="#"
                    style={{width:64}}
                  />
                    tiêm chủng 315</Link>
                {/* <button
                                    className="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 inline-block text-yellow-500 hover:text-yellow-600"><i className="mdi mdi-arrow-left mr-2" />Way back</button> */}
              </div>
            </div>
